...
import { GraduationCap, User, Mail, Lock, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-slate-400">Join EduPulse to access software development & AI courses</p>
      </div>
